...
objTimeBasedComparisonSectionHeading="xpath=.//*[@id='wrapper']//h2[contains(.,'Time based Comparison')] : xpath=.//*[@id='wrapper']//h2[contains(.,'Time based Comparison')] :xpath=.//*[@id='wrapper']//h2[contains(.,'Time based Comparison')]:xpath=.//*[@id='wrapper']//h2[contains(.,'Time based Comparison')]"
